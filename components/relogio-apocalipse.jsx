...
const r = (oracleResult && oracleResult.success) ? oracleResult : MOCK;
  ...
  const tclr = seconds<=60?C.red:seconds<=90?C.red:C.red;
            ...
            <div>
              ...
              <div style={{ border: `1px solid ${C.border}`, background: C.bgCard, padding: "22px", textAlign: "center", marginBottom: 16 }}>
                ...
                <div style={{ fontSize: 14, color: C.gray, lineHeight: 1.7, marginBottom: 18 }}>
                  O Oráculo busca notícias reais, analisa ameaças globais e recalcula a data prevista do colapso. A cada consulta o relógio pode avançar ou recuar.
                </div>
